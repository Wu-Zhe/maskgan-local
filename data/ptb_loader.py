...
def ptb_raw_data(data_path=None):
  ...
  train_path = os.path.join(data_path, "ptb.train.subset.txt")
  # valid_path = os.path.join(data_path, "ptb.valid.subset.txt")
  # test_path = os.path.join(data_path, "ptb.test.subset.txt")
